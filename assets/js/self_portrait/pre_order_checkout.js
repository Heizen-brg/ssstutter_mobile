...
let items_purchased = JSON.parse(localStorage.getItem("self-portrait-item"));
let order_data = {
  customerPhone: "",
  customerName: "",
  customerEmail: "",
...
export const __templates_checkout_pre_order = {
  ...
  checkout__cart() {
    let data_cart = JSON.parse(localStorage.getItem("self-portrait-item"));
      ...
      __requests(
        ...
        ({ data, error }) => {
          if (data.paymentUrl) {
            ...
            localStorage.removeItem("self-portrait-item");
